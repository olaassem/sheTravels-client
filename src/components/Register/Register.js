...
import {registerUser} from '../../actions/index'; //action we want to trigger
                  ...
                  <label htmlFor="agegroup">Age Group</label>
                    <div className="custom-select">
                      <select>
                        ...
                        <option id="age" value="40s">40s</option>
                        <option id="age" value="50s">50s</option>
                        <option id="age" value="60s">60s</option>
                        <option id="age" value="70s +">70s +</option>
                      </select>
                    </div>
                  </div>
            <button
